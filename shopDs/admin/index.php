...
<body>
    ...
    <div class="operation_user clearfix">
       <!--   <div class="link fl"><a href="#">电商</a><span>&gt;&gt;</span><a href="#">商品管理</a><span>&gt;&gt;</span>商品修改</div>-->
        <div class="link fr">
            <b>欢迎您
            <?php
        ...
        <div class="main">
            ...
            <div class="cont">
                <div class="title">后台管理</div>
      	 		<!-- 嵌套网页开始 -->
                <iframe src="main.php" style="border: none;" name="mainFrame" width="100%" height="522"></iframe>
                <!-- 嵌套网页结束 -->
            </div>
        </div>
        <!--左侧列表-->
